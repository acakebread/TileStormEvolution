...
namespace ClassicTilestorm
{
	public interface IEditorAttachmentHandler
	{
		...
		void OnDeselect(IMapEdit iMap, Camera camera, ISelectable selection) { } // Default: do nothing
		void OnUpdate(IMapEdit map, Camera camera, ISelectable selection) { } // Default: do nothing
