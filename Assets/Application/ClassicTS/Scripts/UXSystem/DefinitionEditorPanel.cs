...
//			currentModelData = null;
//			previewCtrl.ClearModel();
//			previewCtrl.ClearAdditionalModels();   // Clear any previous arrows
...
//					// Position ground slightly below the model
//					float lowestY = currentModelData.bounds.min.y;
//					previewCtrl.GroundY = lowestY + groundY;
...
//				// === Add navigation arrows for active flags ===
//				if (arrow != null && def != null)
//				{
//					AddNavigationArrows(def);
//				}
...
//			else
//			{
//				// No model → reset ground and camera
//				previewCtrl.GroundY = groundY;
//				orbitController.ResetView(false);
//			}
...
//			// Slight offset above the ground so the arrow doesn't clip
//			const float arrowHeight = 0.02f;   // tweak if your arrow is thick/thin

//			// Use the model's lowest point as reference so arrows sit nicely on/near ground
//			float baseY = currentModelData?.bounds.min.y ?? 0f;
//			Vector3 arrowPosition = new Vector3(0f, baseY + arrowHeight, 0f);

//			// North
//			if (def.North)
//			{
//				var arrowData = CommandRenderModelData.Instantiate(
//					arrow,
//					position: arrowPosition + Vector3.forward,
//					rotation: Quaternion.Euler(0f, 0f, 0f)   // North = forward (+Z)
//				);
//				if (arrowData != null) previewCtrl.AddModel(arrowData);
//			}
...
//				var arrowData = CommandRenderModelData.Instantiate(
//					arrow,
//					position: arrowPosition + Vector3.right,
//					rotation: Quaternion.Euler(0f, 90f, 0f)  // East = +X
//				);
//				if (arrowData != null) previewCtrl.AddModel(arrowData);
//			}
...
//				var arrowData = CommandRenderModelData.Instantiate(
//					arrow,
//					position: arrowPosition + Vector3.back,
//					rotation: Quaternion.Euler(0f, 180f, 0f) // South = -Z
//				);
//				if (arrowData != null) previewCtrl.AddModel(arrowData);
//			}
...
//				var arrowData = CommandRenderModelData.Instantiate(
//					arrow,
//					position: arrowPosition + Vector3.left,
//					rotation: Quaternion.Euler(0f, 270f, 0f) // West = -X (or -90°)
//				);
//				if (arrowData != null) previewCtrl.AddModel(arrowData);
//			}
//		}
...
//		// Helper method
//		private bool HasAnyNavigationFlag(Definition def)
//		{
//			if (def == null) return false;
//			return def.North || def.East || def.South || def.West;
//		}
