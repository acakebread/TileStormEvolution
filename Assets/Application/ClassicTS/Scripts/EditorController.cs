...
namespace ClassicTilestorm
{
	public class EditorController : MonoBehaviour
	{
		...
		private void Start()
		{
			...
			if (null == panelBackgroundTexture) panelBackgroundTexture = TextureUtils.MakeTex(4, 4, new Color(0.2f, 0.2f, 0.4f, 0.75f));
			if (null == saveBackgroundTexture) saveBackgroundTexture = TextureUtils.MakeTex(4, 4, new Color(0.8f, 0.2f, 0.2f, 1f));
			if (null == gridButtonBackgroundTexture) gridButtonBackgroundTexture = TextureUtils.MakeTex(4, 4, new Color(0.5f, 0.5f, 0.5f, 1f));
			if (null == toggleOffBackgroundTexture) toggleOffBackgroundTexture = TextureUtils.MakeTex(4, 4, new Color(0.3f, 0.3f, 0.3f, 1f)); // Dark gray for off
			if (null == toggleOnBackgroundTexture) toggleOnBackgroundTexture = TextureUtils.MakeTex(4, 4, new Color(0.3f, 0.6f, 0.3f, 1f)); // Greenish for on
		...
		void OnDestroy()
		{
			...
			if (null != panelBackgroundTexture)
			{
				Destroy(panelBackgroundTexture);
				panelBackgroundTexture = null;
			}
			if (null != saveBackgroundTexture)
			{
				Destroy(saveBackgroundTexture);
				saveBackgroundTexture = null;
			}
			if (null != gridButtonBackgroundTexture)
			{
				Destroy(gridButtonBackgroundTexture);
				gridButtonBackgroundTexture = null;
			}
			if (null != toggleOffBackgroundTexture)
			{
				Destroy(toggleOffBackgroundTexture);
				toggleOffBackgroundTexture = null;
			}
			if (null != toggleOnBackgroundTexture)
			{
				Destroy(toggleOnBackgroundTexture);
				toggleOnBackgroundTexture = null;
			}
			if (null != toggleHoverBackgroundTexture)
			{
				Destroy(toggleHoverBackgroundTexture);
