...
namespace ClassicTilestorm
{
	public class EditorControllerAttachment : EditorControllerMovement
	{
		...
		public override void OnGUI()
		{
			...
			{
				case PendingAction.Add: if (AttachmentEditing.DrawAddPopup(mouseDownPos, iMapManager, camera, AttachmentEditing.CurrentPendingTile)) return; break;
				case PendingAction.Delete: if (AttachmentEditing.DrawDeletePopup(mouseDownPos, iMapManager, camera, AttachmentEditing.CurrentPendingTile)) return; break;
				case PendingAction.Select: if (AttachmentEditing.DrawSelectPopup(mouseDownPos, iMapManager, camera, AttachmentEditing.CurrentPendingTile)) return; break;
			}
