...
//public class CommandBufferPass : ScriptableRenderPass
//{
//	private string passNameStr; // Renamed to avoid conflict
...
//			{
//				// Debug.LogError($"{passNameStr}: Invalid render targets: Color={colorTarget.IsValid()}, Depth={depthTarget.IsValid()}, Camera={cam.name}");
//				return;
//			}
