...
//		/// <summary>
//		/// Encodes an integer array using simple run-length encoding.
//		/// Output format: [value1, count1, value2, count2, ...]
//		/// </summary>
//		public static int[] RleEncode(this int[] source)
//		{
//			if (source == null || source.Length == 0)
//				return Array.Empty<int>();
...
//		/// <summary>
//		/// Decodes a run-length encoded integer array back to the original.
//		/// Expects input in the format: [value1, count1, value2, count2, ...]
//		/// </summary>
//		public static int[] RleDecode(this int[] encoded)
//		{
//			if (encoded == null || encoded.Length == 0 || encoded.Length % 2 != 0)
//				return Array.Empty<int>(); // invalid → return empty
...
//		/// <summary>
//		/// Quick check if an encoded array looks valid (even length, positive counts)
//		/// </summary>
//		public static bool IsValidRle(this int[] encoded)
//		{
//			if (encoded == null || encoded.Length == 0 || encoded.Length % 2 != 0)
//				return false;
