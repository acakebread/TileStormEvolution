	...
	public class CommandRenderCamera
	{
			...
			Transform desiredParent = null)
		{
			...
			if (camData != null)
			{
				...
				// Try to suppress additional lights entirely
				//camData.additionalLightsShadowResolutionTier = 0; // may not exist in all URP versions - comment if compile error
			}
		...
		public void Render()
		{
			// REMOVED the SetGlobalInt line - this was causing the warning on first launch
...
//			// === CRITICAL ADDITIONS FOR ICON RENDERING ===
//			var camData = Camera.GetUniversalAdditionalCameraData();
//			if (camData != null)
//			{
//				camData.requiresColorOption = CameraOverrideOption.Off;   // or .On if you need it
//				camData.requiresDepthOption = CameraOverrideOption.Off;
//				camData.renderShadows = false;
//				camData.requiresColorTexture = false;
//				camData.requiresDepthTexture = false;

//				// This is the key for your error:
//				//camData.additionalLightsShadowResolutionTier = 0; // or just leave default
//																  // Force no additional lights
//																  // In newer URP you can also try:
//																 // camData.lightData.additionalLightsCount = 0; // if accessible
//			}

//			// Force Forward rendering path (more stable for this use case)
//			Camera.renderingPath = RenderingPath.Forward; // though URP ignores this somewhat
