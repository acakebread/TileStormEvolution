...
namespace MassiveHadronLtd.LegacyTouchInterpreter
{
	public class TouchInterpreter : MonoBehaviour
	{
		...
		public void OnGUI() { if (true == showTouches) MassiveHadronLtd.MultiTouchEmulator.OnGUI(); }
	}

	public static class MultiTouchEmulator
	{
		public static Touch[] touches => MassiveHadronLtd.MultiTouchEmulator.touches;
		public static void OnGUI() => MassiveHadronLtd.MultiTouchEmulator.OnGUI();
	}
}
