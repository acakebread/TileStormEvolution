...
namespace MassiveHadronLtd
{
	public static class ScreenSpaceUtil
	{
		...
		public static void OnGUI(Rect rect, Vector2 coord = default)
		{
...
//		private static Vector2 _lastCoord = new(-999f, -999f);
...
//		public static Texture2D GetTexture() => null != _currentAtlas ? _currentAtlas.Texture : _quadTexture;
...
//			{
//				if (_mainRT != null) _mainRT.Release();
//				_mainRT = new RenderTexture(w, h, 0, RenderTextureFormat.ARGB32) { filterMode = FilterMode.Bilinear };
//				_mainRT.Create();
//				_gridDirty = true;
//			}
...
//			{
//				if (_selectedRT != null) _selectedRT.Release();
//				_selectedRT = new RenderTexture(selSize, selSize, 0, RenderTextureFormat.ARGB32) { filterMode = FilterMode.Bilinear };
//				_selectedRT.Create();
//				_selectedDirty = true;
//			}
...
//				_quadTexture = Texture2D.whiteTexture;
